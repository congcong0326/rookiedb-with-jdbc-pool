...
public class SortMergeOperator extends JoinOperator {
    ...
    private class SortMergeIterator implements Iterator<Record> {
        ...
        */
         ...
         * 1.比较leftRecord与rightRecord，如果leftRecord>rightRecord,rightRecord++，如果如果leftRecord==rightRecord则join
         */
        private Record fetchNextRecord() {
            ...
            //marked 为 Sort-Merge Join 中重复值的处理策略
            //初次相等时，right 向前扫描以找出所有匹配项（即构建匹配窗口）
            //然后在 left 的重复值上逐个走，重复使用 right 的匹配窗口
            if (!marked) {
                marked = true;
