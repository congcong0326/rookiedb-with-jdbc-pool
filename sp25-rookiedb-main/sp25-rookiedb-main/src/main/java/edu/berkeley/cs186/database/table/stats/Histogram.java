...
public class Histogram {
     ...
     *  通过扫描表中的每行数据，初始化一个直方图的每个桶，与桶的开始与结束值
     *  然后再次扫描，填充直方图
     */
     ...
     * 接收一个谓词操作符和一个值，返回一个浮点数组，表示直方图中每个桶在该谓词条件下的 选择性因子 （0到1之间的值）
     *
     */
     ...
     * WHERE子句优化 ：估算 WHERE column > value 这类条件的选择性
     */
     ...
     *         0    10   20   30   40   50]
     *
     * 方法根据给定的谓词条件（如 WHERE age > 25 ）创建一个新的直方图，反映过滤后的数据分布情况。
     *
     */
